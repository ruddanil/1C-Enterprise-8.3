Функция СформироватьОтчет()	Экспорт
	...
	Запрос.УстановитьПараметр("Организация", фд_РаботаСПредопределеннымиПризнакамиВызовСервера.ПолучитьЭлементПоПризнаку("*******"));
	Запрос.УстановитьПараметр("Контрагент", фд_РаботаСПредопределеннымиПризнакамиВызовСервера.ПолучитьЭлементПоПризнаку("*******"));
	Запрос.Текст = 
		"ВЫБРАТЬ
